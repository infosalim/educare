...
const courses: Course[] = [
  ...
  { id: 7, title: "Business", thumbnail: "/assets/images/categories/business.jpg" },
              ...
              <Link key={course.id} href={`/courses/${course.id}`}>
                <div className="group hover:shadow-sm transition overflow-hidden border rounded-lg p-3 h-full">
                  <div className="relative w-full aspect-video rounded-md overflow-hidden">
                    <Image src={course.thumbnail} alt={course.title} className="object-cover" fill />
                  </div>
                  <div className="flex flex-col pt-2">
                    ...
                    <CourseProgress size="sm" value={80} variant={80 >= 100 ? "success" : "default"} />
